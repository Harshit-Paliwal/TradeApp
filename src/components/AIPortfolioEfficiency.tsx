...
interface AIPortfolioEfficiencyProps {
  score: number;
  metrics: EfficiencyMetric[];
}

export default function AIPortfolioEfficiency({ score, metrics }: AIPortfolioEfficiencyProps) {
  return (
    <div className="bg-[#141414] border border-white/10 p-8 rounded-[40px] relative overflow-hidden h-full">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h3 className="text-xl font-black tracking-tight">AI Portfolio Efficiency</h3>

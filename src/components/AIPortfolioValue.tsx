...
interface AIPortfolioValueProps {
  score: number;
  metrics: ValueMetric[];
}

export default function AIPortfolioValue({ score, metrics }: AIPortfolioValueProps) {
  return (
    <div className="bg-[#141414] border border-white/10 p-8 rounded-[40px] relative overflow-hidden h-full">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h3 className="text-xl font-black tracking-tight">AI Portfolio Value</h3>

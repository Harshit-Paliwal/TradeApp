...
import { Zap, Shield, Target, Activity, AlertCircle, TrendingUp } from 'lucide-react';
...
interface AIPortfolioLiquiditiesProps {
  score: number;
  metrics: LiquidityMetric[];
}

export default function AIPortfolioLiquidities({ score, metrics }: AIPortfolioLiquiditiesProps) {
  return (
    <div className="bg-[#141414] border border-white/10 p-8 rounded-[40px] relative overflow-hidden h-full">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h3 className="text-xl font-black tracking-tight">AI Portfolio Liquidities</h3>
          <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Asset Liquidity Analysis</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-8 mb-8 relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <span className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Liquidity Score</span>
        </div>
      </div>

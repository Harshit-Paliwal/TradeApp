...
interface AIPortfolioHealthsProps {
  score: number;
  metrics: HealthMetric[];
}

export default function AIPortfolioHealths({ score, metrics }: AIPortfolioHealthsProps) {
  return (
    <div className="bg-[#141414] border border-white/10 p-8 rounded-[40px] relative overflow-hidden h-full">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h3 className="text-xl font-black tracking-tight">AI Portfolio Healths</h3>
          <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Comprehensive Portfolio Analysis</p>
        </div>
      </div>

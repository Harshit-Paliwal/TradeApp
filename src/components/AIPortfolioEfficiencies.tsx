...
interface AIPortfolioEfficienciesProps {
  score: number;
  metrics: EfficiencyMetric[];
}

export default function AIPortfolioEfficiencies({ score, metrics }: AIPortfolioEfficienciesProps) {
  return (
    <div className="bg-[#141414] border border-white/10 p-8 rounded-[40px] relative overflow-hidden h-full">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h3 className="text-xl font-black tracking-tight">AI Portfolio Efficiencies</h3>
          <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Capital Utilization Analysis</p>
        </div>
      </div>

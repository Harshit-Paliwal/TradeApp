...
export default function AIPortfolioHealth({ score, metrics }: AIPortfolioHealthProps) {
  return (
    <div className="bg-[#141414] border border-white/10 p-8 rounded-[40px] relative overflow-hidden h-full">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h3 className="text-xl font-black tracking-tight">AI Portfolio Health</h3>
      ...
      <div className="flex flex-col items-center justify-center py-8 mb-8 relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <span className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Health Score</span>
        </div>
      </div>

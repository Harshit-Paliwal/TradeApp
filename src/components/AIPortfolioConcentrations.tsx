...
interface AIPortfolioConcentrationsProps {
  score: number;
  metrics: ConcentrationMetric[];
}

export default function AIPortfolioConcentrations({ score, metrics }: AIPortfolioConcentrationsProps) {
  return (
    <div className="bg-[#141414] border border-white/10 p-8 rounded-[40px] relative overflow-hidden h-full">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h3 className="text-xl font-black tracking-tight">AI Portfolio Concentrations</h3>

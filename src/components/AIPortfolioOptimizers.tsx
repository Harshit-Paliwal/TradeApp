...
import { Target, Shield, Zap, TrendingUp, Activity, PieChart } from 'lucide-react';
...
interface AIPortfolioOptimizersProps {
  score: number;
  metrics: OptimizationMetric[];
}

export default function AIPortfolioOptimizers({ score, metrics }: AIPortfolioOptimizersProps) {
  return (
    <div className="bg-[#141414] border border-white/10 p-8 rounded-[40px] relative overflow-hidden h-full">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h3 className="text-xl font-black tracking-tight">AI Portfolio Optimizers</h3>
          <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Capital Efficiency Analysis</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-8 mb-8 relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <span className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Efficiency Score</span>
        </div>
      </div>
